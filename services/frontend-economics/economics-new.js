...
function calculateEaaSEffectivePrice(params) {
  ...
  console.log('🔍 calculateEaaSEffectivePrice - eaasSubscriptionPLNperYear:', eaasSubscriptionPLNperYear);
...
function calculateEaaS() {
  ...
  console.log('🔍 DEBUG - annualSubscriptionPLN field:', subscriptionData.annualSubscriptionPLN);
  console.log('🔍 DEBUG - annualSubscription field:', subscriptionData.annualSubscription);
  console.log('🔍 DEBUG - currency:', subscriptionData.currency);
  ...
  console.log('🔍 DEBUG - eaasSubscriptionPLN variable:', eaasSubscriptionPLN);
  console.log('🔍 DEBUG - eaasSubscription variable:', eaasSubscription);
